                ...
                <form wire:submit="save" class="space-y-6">
                    ...
                    @if(!$userId)
                        ...
                        <div>
                            ...
                            <input type="password" 
                                   ...
                                   class="w-full max-w-xl rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            @error('password') 
                                <span class="text-red-500 text-sm mt-1">{{ $message }}</span> 
                            @enderror
                        </div>
                    ...
                    <div class="flex justify-end gap-2 pt-4">
                        <a href="{{ route('staff.users.index') }}" wire:navigate
                           class="px-6 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 text-sm rounded-md hover:bg-gray-300 dark:hover:bg-gray-600 transition">
                            Cancelar
                        </a>
                        <button type="submit"
                                class="px-6 py-2 bg-indigo-600 text-white text-sm rounded-md hover:bg-indigo-700 transition">
