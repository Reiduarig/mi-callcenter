<div class="py-6" x-on:confirmed-delete.window="$wire.delete($event.detail.id)">
            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <div class="mb-4 flex gap-4">
                    <input type="text" 
                           ...
                           class="flex-1 md:flex-none md:w-96 rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            @forelse($users as $user)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex gap-1 flex-wrap">
                                            @forelse($user->roles as $role)
                                                <span class="px-2 py-1 text-xs font-medium bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-200 rounded">
                                                    {{ ucfirst($role->name) }}
                                                </span>
                                            @empty
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('staff.users.edit', $user->id) }}" wire:navigate
    ...
    {{-- <div x-data="{ show: false }" 
         x-on:confirm-delete.window="show = true"
         x-show="show"
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-lg px-4 pt-5 pb-4 overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full sm:p-6">
                ...
                <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                    <button wire:click="delete({{ $deleteId }}); show = false" 
                            type="button"
